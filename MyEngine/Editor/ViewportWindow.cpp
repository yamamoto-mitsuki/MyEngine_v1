...
void ViewportWindow::Draw(RenderTexture* rt) {
	...
	dl->AddRectFilled({contentMin.x - 15, contentMin.y - 15}, {contentMax.x + 15, imageMin.y}, m);
	dl->AddRectFilled({contentMin.x - 15, imageMax.y}, {contentMax.x + 15, contentMax.y + 15}, m);
	dl->AddRectFilled({contentMin.x - 15, imageMin.y}, {imageMin.x, imageMax.y}, m);
	dl->AddRectFilled({imageMax.x, imageMin.y}, {contentMax.x + 15, imageMax.y}, m);
